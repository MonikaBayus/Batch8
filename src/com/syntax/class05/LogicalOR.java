...
public class LogicalOR {
	...
	public static void main(String[] args) {
		...
		/*
		 * if day is 1 or 5 -----> I am off from Syntax if day 2 or 3 ----> GIT classes
		 * if day is 4 ----->Review Class if day 6 or 7 -----> Java Class everything
		 * else will be invalid day
		 */
		...
		if (today == 1 || today == 5) {
			...
			System.out.println("Please enter a valid day from 1 to7");
		}
	}
}
